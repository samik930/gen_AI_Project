...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        const hasResume = resumeFile !== undefined && resumeFile !== null;

        const fieldsProvided = [hasJobDescription, hasSelfDescription, hasResume].filter(Boolean).length;

        if (hasResume && hasSelfDescription && !hasJobDescription) {
            alert("Please provide a Job Description along with your Resume and Self Description.");
            return;
        }
